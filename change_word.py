...
def main():
    ...
    markku_tervahauta = ["Peter Forsberg", "Katla", "Darth Vader", "Markoolio"]
    ...
    print((
              f"""{en_app[random.randint(0, 3)]} som kan laddas ned till {mobiltelefonen[random.randint(0, 3)]} ska varna finländare som kommit nära någon som smittats med {coronaviruset[random.randint(0, 3)]}.
